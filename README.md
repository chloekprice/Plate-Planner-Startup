...
### Design
![Image of the proposed Plate Planner layout, including a login page, calendar page, and shopping list page.] (https://github.com/chloekprice/startup/blob/main/startup_design.jpg?raw=true)
